...
if ( ! class_exists( 'CountryList' ) ) {
	...
	class CountryList {
		...
		public static function get_default_countrycode_deprecated() {
			return ! MoUtility::is_blank( get_mo_wc_option( 'default_country_code' ) )
						? get_mo_wc_option( 'default_country_code' ) : null;
		}


		/**
		 * Deprecated function: Checks if country is selected.
		 *
		 * @param string $value - the value of the default country code.
		 */
		public static function is_country_selected_deprecated( $value ) {
			return ! MoUtility::is_blank( get_mo_wc_option( 'default_country_code' ) )
						&& get_mo_wc_option( 'default_country_code' ) === $value;
		}
		...
		public static function get_default_country_data() {
			return ! MoUtility::is_blank( get_mo_wc_option( 'default_country' ) )
						? maybe_unserialize( get_mo_wc_option( 'default_country' ) ) : null;
		}
		...
		public static function is_country_selected( $value, $alphacode ) {
			...
			$new_value = self::get_default_country_data();
			return $old_value ? $old_value : ( ! MoUtility::is_blank( $new_value ) && $alphacode === $new_value['alphacode'] );
		}
