...
if ( ! class_exists( 'WooCommerceOrderCancelledNotification' ) ) {
	...
	class WooCommerceOrderCancelledNotification extends SMSNotification {
		...
		protected function __construct() {
			...
			$this->page_header       = mowc_( 'ORDER CANCELLED NOTIFICATION SETTINGS' );
			$this->page_description  = mowc_( 'SMS notifications sent to the users when order status changes to Order Cancellation.' );
