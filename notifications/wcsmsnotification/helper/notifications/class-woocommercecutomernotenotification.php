...
if ( ! class_exists( 'WooCommerceCutomerNoteNotification' ) ) {
	...
	class WooCommerceCutomerNoteNotification extends SMSNotification {
		...
		protected function __construct() {
			...
			$this->page_header       = mowc_( 'CUSTOMER NOTE NOTIFICATION SETTINGS' );
			$this->page_description  = mowc_( 'SMS notifications sent to an customer when Note is added to an Order.' );
