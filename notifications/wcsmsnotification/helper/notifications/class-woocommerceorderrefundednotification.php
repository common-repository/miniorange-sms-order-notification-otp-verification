...
if ( ! class_exists( 'WooCommerceOrderRefundedNotification' ) ) {
	...
	class WooCommerceOrderRefundedNotification extends SMSNotification {
		...
		protected function __construct() {
			...
			$this->page_header       = mowc_( 'ORDER REFUNDED NOTIFICATION SETTINGS' );
			$this->page_description  = mowc_( 'SMS notifications sent to the user when Order Payment is Refunded.' );
