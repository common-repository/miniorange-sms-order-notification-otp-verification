...
if ( ! class_exists( 'WooCommerceOrderOnHoldNotification' ) ) {
	...
	class WooCommerceOrderOnHoldNotification extends SMSNotification {
		...
		protected function __construct() {
			...
			$this->page_header       = mowc_( 'ORDER ON-HOLD NOTIFICATION SETTINGS' );
			$this->page_header       = mowc_( 'ORDER ON-HOLD NOTIFICATION SETTINGS' );
			$this->page_description  = mowc_( 'SMS notifications sent to the users when order status changes to on-hold.' );
		...
		public function send_sms( array $args ) {
			...
			$payment_mode   = $order_details->get_payment_method_title();
