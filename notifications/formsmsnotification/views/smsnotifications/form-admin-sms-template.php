...
echo '				<div>
						...
						<div class="w-full flex">
								...
								<div class="flex-1 flex flex-wrap">
									<input type="text" name="' . esc_attr( $recipient_tag ) . '" id="' . esc_attr( $recipient_tag ) . '" value="' . esc_attr( $recipient_value ) . '"  class="w-full mowc-input" placeholder="' . esc_html( mowc_( 'Enter semi-colon (;) to separate multiple phone numbers.' ) ) . '"/>
								';
