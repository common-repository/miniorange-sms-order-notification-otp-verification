<?php
/**
 * Load admin view for Form Customer SMS Notification.
 *
...
echo '				<div>
						...
						<div class="w-full flex">
								<div class="flex-1">
									<h5 class="mowc-title flex items-center gap-mowc-2">
										' . esc_html( 'Phone Field Name' ) . '
									</h5>
									<p class="mowc-caption mt-mowc-2">Enter the ' . esc_html( $sms_settings->phone_input ) . ' of your ' . esc_html( $sms_settings->title ) . '</p>
								</div>
								<div class="flex-1 flex flex-wrap">
									<input type="text" name="' . esc_attr( $recipient_tag ) . '" id="' . esc_attr( $recipient_tag ) . '" value="' . esc_attr( $recipient_value ) . '" class="w-full mowc-input" placeholder="' . esc_html( mowc_( 'Enter the Name of Phone Number Field.' ) ) . '"/>
								';
						...
						echo '							</div>
							...
							<div class="w-full flex">
								...
								<div class="flex-1">
									<textarea  id="' . esc_attr( $textarea_tag ) . '" class="mowc-textarea mowc_remaining_characters w-full"
