...
if ( ! class_exists( 'PluginPageDetails' ) ) {
	...
	class PluginPageDetails {
		 ...
		 */
		public function __construct( $icon, $page_title, $menu_slug, $menu_title, $tab_name, $request_uri, $view, $id, $css = '', $show_in_nav = true ) {
