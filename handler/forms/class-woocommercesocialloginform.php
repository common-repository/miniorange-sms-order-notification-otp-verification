...
if ( ! class_exists( 'WooCommerceSocialLoginForm' ) ) {
	...
	class WooCommerceSocialLoginForm extends FormHandler implements IFormHandler {
		...
		protected function __construct() {
			...
			$this->form_name               = mowc_( 'WooCommerce Social Login ( SMS Verification Only )' );
			$this->is_form_enabled         = get_mo_wc_option( 'wc_social_login_enable' );
		...
		public function includeRequiredFiles() {
			...
			if ( is_plugin_active( 'woocommerce-social-login/woocommerce-social-login.php' ) ) {
				require_once plugin_dir_path( MOV_WC_DIR ) . 'woocommerce-social-login/includes/class-wc-social-login-provider-profile.php';
			}
		}
		...
		public function create_new_wc_social_customer( $user_data ) {
			require_once plugin_dir_path( MOV_WC_DIR ) . 'woocommerce/includes/class-wc-emails.php';
		...
		public function handle_form_options() {
			...
			update_mo_wc_option( 'wc_social_login_enable', $this->is_form_enabled );
		}
	}
}
