...
echo '<div id="' . esc_attr( $premium_notif_id ) . '" class="mowc-subpage-container ' . esc_attr( $premium_notif_hidden ) . '">
        <div class="pb-mo-2 px-mowc-8">
            <div class="mo_otp_note flex gap-mowc-2 my-mowc-3">
                <svg width="18" class="my-mowc-3 ml-mowc-4" height="18" viewBox="0 0 24 24" fill="none">
                ...
                <div class="my-mowc-3">' . wp_kses( $notif_subtab['discription'], MoUtility::mowc_allow_html_array() ) . '
                </div>
            </div>
        </div>
    </div>';
