...
<div class="w-[368px] contact-us-container duration-300"> 
    <div class="flex gap-mowc-4 relative justify-end" id="mowc_contact_us">
        <input id="contact-us-toggle" type="checkbox" class="peer sr-only"/>

        <span onClick="otpSupportOnClickWC(\'\')" class="flex-1 flex relative items-center h-[68px] bg-gradient-to-r from-blue-600 to-blue-700 px-mowc-4 rounded-smooth shadow-md">
            <span class="mowc-heading text-white leading-normal">Hello there! Need Help?<br>Drop us an Email</span>
        </span>

        <span onClick="otpSupportOnClickWC(\'\')">
        ...
        <div class="mowc_contactus_popup_container" style="display:none;">
        </div>
        <div id="mowc-contact-form" class="overflow-hidden hidden peer-checked:block absolute right-mowc-0 bottom-mowc-0 bg-white shadow-lg rounded-smooth border animate-fade-in-up">
            <div class="mowc-header">
                <h5 class="mowc-heading flex-1">Contact us</h5>
                <label id="mowc_close_contactus" class="mowc-icon-button" for="contact-us-toggle">
            ...
            <form name="f" method="post" action="" class="flex flex-col gap-mowc-3 p-mowc-6">';
			wp_nonce_field( $nonce );
			echo '
                <p class="leading-loose">Need any help? Just send us a query and we will get in touch.</p>
                <input type="hidden" name="option" value="mowc_validation_contact_us_query_option">
                   
                        <input type="email" class="mowc-input" id="query_email" name="query_email" value="' . esc_attr( $email ) . '"
                            placeholder="' . esc_attr( mowc_( 'Enter your Email' ) ) . '" required />
                  
                    
                        <input type="text" class="mowc-input" name="query_phone" id="query_phone" value="' . esc_attr( $phone ) . '"
                            placeholder="' . esc_attr( mowc_( 'Enter your phone' ) ) . '"/>
                 
                            <textarea id="contactQuery" name="query" class="mowc-textarea h-[100px]"
                ...
                <a href="mailto:otpsupport@xecurify.com" class="mowc-button secondary">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" class="-ml-mowc-4">
