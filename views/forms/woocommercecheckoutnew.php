			...
			<div class="flex">
              	<label class="mowc-checkbox-container flex-1">
 	        		<input  type="checkbox" ' . esc_attr( $disabled ) . ' 
 	        	        id="wc_checkout_new" 
 	        	        data-toggle="wc_checkout_new_options" 
				...
				<div data-show="false" data-toggle="wc_checkout_new_options" class="mowc-toggle-div before:content-none border flex items-center justify-center rounded-full border-slate-400">
...
echo '		<div class="mowc-form-options" ' . esc_attr( $wc_new_checkout_hidden ) . ' id="wc_checkout_new_options" style="display:none;">

				<div class="mowc-otptype-radio-container">

					<div>
						<input  type="radio" ' . esc_attr( $disabled ) . ' 
						        id="wc_checkout_new_email" 
						...
						<label for="wc_checkout_new_email" class="mowc-otptype-radio-label" id="wc_new_checkout_email_div">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<div>
						<input  type="radio" ' . esc_attr( $disabled ) . ' 
						        id="wc_checkout_new_phone" 
						        class="app_enable peer sr-only" 
						        name="mo_customer_validation_wc_new_checkout_type" 
						        value="' . esc_attr( $wc_new_type_phone ) . '"
							    ' . ( esc_attr( $wc_new_checkout_enable_type ) === esc_attr( $wc_new_type_phone ) ? 'checked' : '' ) . '/>
						
						<label for="wc_checkout_new_phone" class="mowc-otptype-radio-label" id="wc_new_checkout_phone_div">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
