...
echo ' 	<div class="mowc-formsettings-container" id="' . esc_attr( get_mo_wc_class( $handler ) ) . '">
			...
			<div class="flex">
				...
				<div data-show="false" data-toggle="wc_checkout_options" class="mowc-toggle-div before:content-none border flex items-center justify-center rounded-full border-slate-400">
...
echo '		<div class="mowc-form-options" ' . esc_attr( $wc_checkout_hidden ) . ' id="wc_checkout_options" style="display:none;">
				...
				<div class="mowc-otptype-radio-container">
					...
					<div>
						...
						<label for="wc_checkout_email" class="mowc-otptype-radio-label" id="wc_checkout_email_div">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<div>
						...
						<label for="wc_checkout_phone" class="mowc-otptype-radio-label" id="wc_checkout_phone_div">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
				...
				<div class="' . ( esc_attr( $wc_checkout_enable_type ) !== esc_attr( $wc_type_phone ) ? 'hidden' : '' ) . '" id ="wc_restrict_duplicates_checkout_option" ">
					<label class="mowc-checkbox-container flex-1" >
	                    <input  type="checkbox" ' . esc_attr( $disabled ) . ' 
	                            id="wc_checkout_restrict_duplicates"
				...
				<label class="mowc-checkbox-container flex-1">
					<input  type="checkbox" 
					        ...
					        value="1" >
                	<span class="mowc-checkmark"></span>
                	<p class="mowc-title">' . esc_html( mowc_( 'Enable Verification only for Guest Users.' ) ) . '</p>
              	</label>
				...
				<label class="mowc-checkbox-container flex-1">
					<input  type="checkbox" 
					        ...
					        type="checkbox">
                	<span class="mowc-checkmark"></span>
                	<p class="mowc-title">' . esc_html( mowc_( 'Disable Auto Login after checkout.' ) ) . '</p>
              	</label>
				...
				<label class="mowc-checkbox-container flex-1">
					<input  type="checkbox" 
					        ...
					        type="checkbox">
                	<span class="mowc-checkmark"></span>
                	<p class="mowc-title">' . esc_html( mowc_( 'Show a verification button instead of a link on the WooCommerce Checkout Page.' ) ) . '</p>
              	</label>
				...
				<label class="mowc-checkbox-container flex-1">
					<input  type="checkbox" 
					        ...
					        type="checkbox">
                	<span class="mowc-checkmark"></span>
                	<p class="mowc-title">' . esc_html( mowc_( 'Show a popup for validating OTP.' ) ) . '</p>
              	</label>
				...
				<label class="mowc-checkbox-container flex-1">
					<input  type="checkbox" 
					        ...
					        type="checkbox">
                	<span class="mowc-checkmark"></span>
                	<p class="mowc-title">' . esc_html( mowc_( 'Validate OTP for selective Payment Methods.' ) ) . '</p>
              	</label>
				  ...
				  ' . esc_attr( $checkout_selection_hidden ) . ' style="padding-left:3%;">
				 	<b>
						<label for="wc_payment" style="vertical-align:top;">' .
							esc_html( mowc_( 'Select Payment Methods (Hold Ctrl Key to Select multiple):' ) ) .
						'</label> 
					</b>';

					get_mowc_payment_dropdown( $disabled, $checkout_payment_plans );
