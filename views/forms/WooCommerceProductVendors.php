...
echo '	<div class="mowc-formsettings-container" id="' . esc_attr( get_mo_wc_class( $handler ) ) . '">
			...
			<div class="flex">
				...
				<div data-show="false" data-toggle="wc_pv_default_options" class="mowc-toggle-div before:content-none border flex items-center justify-center rounded-full border-slate-400">
...
echo '		<div class="mowc-form-options" ' . esc_attr( $wc_pv_hidden ) . ' id="wc_pv_default_options" style="display:none;">
				...
				<div class="mowc-otptype-radio-container">
					...
					<div>
						...
						<label for="wc_pv_email" class="mowc-otptype-radio-label" id="wc_email_pv_div">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<div>
						...
						<label for="wc_pv_phone" class="mowc-otptype-radio-label" id="wc_phone_pv_div">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
				...
				<div class="' . ( esc_attr( $wc_pv_enable_type ) !== esc_attr( $wc_pv_reg_type_phone ) ? 'hidden' : '' ) . '" id="wc_pv_phone_options" ">

					<label class="mowc-checkbox-container flex-1">
						<input  type="checkbox" ' . esc_attr( $disabled ) . ' 
						        id = "wc_pv_restrict_duplicates"
							        name="mo_customer_validation_wc_pv_restrict_duplicates" value="1"
									' . esc_attr( $wc_pv_restrict_duplicates ) . ' class="sr-only"/>
	                	<span class="mowc-checkmark"></span>
