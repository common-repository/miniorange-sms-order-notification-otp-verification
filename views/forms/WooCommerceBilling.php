...
echo '	<div class="mowc-formsettings-container" id="' . esc_attr( get_mo_wc_class( $handler ) ) . '">
			...
			<div class="w-full flex items-center">
              	<label class="mowc-checkbox-container flex-1">
                	...
                	<p class="mowc-title">' . esc_html( mowc_( 'Woocommerce Billing Form' ) ) . '</p>
              	</label>
				<div data-show="false" data-toggle="wc_billing_options" class="mowc-toggle-div before:content-none border flex items-center justify-center rounded-full border-slate-400">
...
echo '		<div class="mowc-form-options" ' . esc_attr( $wc_billing_hidden ) . ' id="wc_billing_options" style ="display:none;">
				...
				<div class="mowc-otptype-radio-container">
					...
					<div>
						...
						<label for="wc_billing_email" class="mowc-otptype-radio-label" id="wc_billing_email_div">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
					...
					<div>
						...
						<label for="wc_billing_phone" class="mowc-otptype-radio-label" id="wc_billing_phone_div">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
				...
				<div class="flex items-center" id= "wc_restrict_duplicates_billing_option">
              		<label class="mowc-checkbox-container">
						<input  type="checkbox" ' . esc_attr( $disabled ) . '  
						id = "wc_billing_restrict_duplicates"
				            name="mo_customer_validation_wc_billing_restrict_duplicates" 
							class="sr-only mowc-checkmark"
				            value="1"
				            ' . esc_attr( $wc_restrict_duplicates ) . ' />
              		  	<span class="mowc-checkmark"></span>
              		  	<p class="mowc-title">' . esc_html( mowc_( 'Do not allow users to use the same Phone number or Email for multiple accounts' ) ) . '</p>
              		</label>             
            	</div>
			</div>
		</div>';
